...
f = open(str(input("Enter the name of the file to convert: ")),"r")
inp = f.readline()
outStr = ""
lineNum = 1
while(inp != ""):
    ...
    try:
        ...
        if(instrName == "add"):
            ...
            issue = True
            print("The instruction on line " + str(lineNum) + " is invalid or not supported.")
    except:
        print("There was a problem with your input on line " + str(lineNum) + ". Make sure it's formatted correctly")
    outStr = outStr +  "32'b" + IWord + "; //" + inp
    inp = f.readline()
    lineNum = lineNum + 1
if(not issue):
    print("\n" + outStr + "\n")
